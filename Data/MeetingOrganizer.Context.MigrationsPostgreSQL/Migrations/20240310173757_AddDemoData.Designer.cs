...
namespace MeetingOrganizer.Context.MigrationsPostgreSQL.Migrations
{
    ...
    [Migration("20240310173757_AddDemoData")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MeetingOrganizer.Context.Entities.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MeetingOrganizer.Context.Entities.UserRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MeetingOrganizer.Context.Entities.Participant", b =>
                {
                    ...
                    b.HasOne("MeetingOrganizer.Context.Entities.Role", "Role")
                        .WithMany("Participants")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("MeetingOrganizer.Context.Entities.UserRole", null)
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
